...
class ApprovalsControllerTest < ActionController::TestCase
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post :create, approval: { approved: @approval.approved, approver_id: @approval.approver_id, comments: @approval.comments, created_at: @approval.created_at, order_id: @approval.order_id }
    end
  ...
  test "should update approval" do
    patch :update, id: @approval, approval: { approved: @approval.approved, approver_id: @approval.approver_id, comments: @approval.comments, created_at: @approval.created_at, order_id: @approval.order_id }
    assert_redirected_to approval_path(assigns(:approval))
  end
